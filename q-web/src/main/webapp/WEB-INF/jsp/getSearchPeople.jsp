...
<jsp:include page="models/head.jsp">
	<jsp:param name="title" value="搜索成员" />
</jsp:include>
...
<div id='searchpage' class="search mb15" style="margin-top:13px;">
	<form action="${urlPrefix}/search/people" onsubmit="if(this.search.value=='') return false;" method="GET">
...
<div class="ui-tabs mt10">
    <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix">
        ...
        <li class="ui-state-default crt2 ui-state-un"><a href="${urlPrefix}/search/group">圈子</a></li>
        <li class="ui-state-default crt2 ui-state-active"><a href="${urlPrefix}/search/people">成员</a></li>
    </ul>
</div>
