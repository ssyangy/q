...
<c:otherwise>
	<li class="tab-text ui-state-default ui-corner-top">
		<a class="tab-text" href="${urlPrefix}/group/${group.id}/event">最新活动</a>
	</li>
</c:otherwise>
</c:choose>
<c:choose>
...
<c:otherwise>
	<li class="tab-text ui-state-default ui-corner-top">
		<a class="tab-text" href="${urlPrefix}/group/${group.id}/event?tab=joined">我参加的</a>
	</li>
</c:otherwise>
</c:choose>
<c:choose>
...
<c:otherwise>
	<li class="tab-text ui-state-default ui-corner-top">
		<a class="tab-text" href="${urlPrefix}/group/${group.id}/event?tab=created">我发起的</a>
	</li>
</c:otherwise>
</c:choose>	
</ul>