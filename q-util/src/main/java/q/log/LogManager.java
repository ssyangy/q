...
public class LogManager {
	...
	static {
		try {
			String factory = System.getProperty(FACTORY_CLASS_NAME, "q.log.Log4jInternalLoggerFactory");
		...
		try {
			String factory = System.getProperty(FORMATTER_FACTORY_CLASS_NAME, "q.log.DefaultMessageFormatterFactory");
			Class<?> clazz = Class.forName(factory);
