...
public class IntegerMappingTest {
	...
	/**
	 * Test method for
	 * {@link com.taobao.top.mapping.core.AbstractMapping#mapping(java.lang.Object, com.taobao.top.mapping.core.ExceptionExpress, boolean)}
	 * .
	 * 
	...
	public void testMapping() throws MappingException, OperationCodeException {
		Assert.assertEquals(1, im.mapping(1, null, false).intValue());
		Assert.assertEquals(1, im.mapping((short) 1, null, false).intValue());
		Assert.assertEquals(1, im.mapping((byte) 1, null, false).intValue());
	}
