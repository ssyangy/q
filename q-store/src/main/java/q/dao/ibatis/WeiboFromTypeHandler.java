 ...
 * 
 */
public class WeiboFromTypeHandler implements TypeHandlerCallback {
	...
	public void setParameter(ParameterSetter setter, Object parameter) throws SQLException {
		setter.setInt(parameter == null ? 0 : ((WeiboFromType) parameter).getValue());
	}
	...
	public Object getResult(ResultGetter getter) throws SQLException {
		...
		return WeiboFromType.convertValue(getter.getInt());
	}
	...
	public Object valueOf(String s) {
		return WeiboFromType.convertValue(Integer.valueOf(s));
	}
