 ...
 * 
 */
public class FavoriteFromTypeHandler implements TypeHandlerCallback {
	...
	public void setParameter(ParameterSetter setter, Object parameter) throws SQLException {
		setter.setInt(parameter == null ? 0 : ((FavoriteFromType) parameter).getValue());
	}
	...
	public Object getResult(ResultGetter getter) throws SQLException {
		...
		return FavoriteFromType.convertValue(getter.getInt());
	}
	...
	public Object valueOf(String s) {
		return FavoriteFromType.convertValue(Integer.valueOf(s));
	}
